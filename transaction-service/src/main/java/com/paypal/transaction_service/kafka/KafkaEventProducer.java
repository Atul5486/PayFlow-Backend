...
public class KafkaEventProducer {
    ...
    public  void sendTransactionEvent(String key, Transaction transaction) {
        ...
        future.thenAccept(result -> {
            ...
            System.out.println("Kafka message send successfully " + metadata.topic() + " Partition " + metadata.partition());
        }).exceptionally(ex -> {
            System.err.println("X Failed to send message " + ex.getMessage());
            return null;
        });
    }
