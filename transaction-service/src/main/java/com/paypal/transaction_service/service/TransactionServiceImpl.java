...
public class TransactionServiceImpl implements TransactionService {
    ...
    public Transaction createTransaction(Transaction request) {
        ...
        String walletServiceUrl="http://localhost:8088/api/v1/wallets";
        ...
        try{
            ...
            try{
                ResponseEntity<String> receiveCheck=restTemplate.getForEntity(walletServiceUrl+"/"+receiverId,String.class);

                if(!receiveCheck.getStatusCode().is2xxSuccessful()){
            ...
            System.out.println("Capture Response : "+captureResponse.getStatusCode());
